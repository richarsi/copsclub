...
class ISwimmingMeetEvent(model.Schema, IImageScaleTraversable):
    """
    Events swum at a Swimming Meet[D
    """

    # If you want a schema-defined interface, delete the model.load
    # line below and delete the matching file in the models sub-directory.
    # If you want a model-based interface, edit
    # models/swimming_meet_event.xml to define the content type.

    model.load("models/swimming_meet_event.xml")
